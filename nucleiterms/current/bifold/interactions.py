...
def v_j00_m3y_reid(e_lab, a_proj):
    ...
    """
    return -276 * 1000000 * (1 - 0.005*e_lab/a_proj) / (1e-15) # eV.m^3
...
def v_j00_m3y_paris(e_lab, a_proj):
    ...
    doi:10.1103/physrevc.51.2069
    """
    return -590 * 1000000 * (1 - 0.002*e_lab/a_proj) / (1e-15) # MeV.fm^3
#..........................................................................#
#**************************** M3Y - Reid/Paris ****************************#
#..........................................................................#
...
def v_xdm3yn_cabgn(dd_name='bdm3y1', vnn_name='reid'):
    ...
    params_dict = {
        'reid':{        #C      alpha     beta   gamma   n    K [eV]  Implemented
            'dim3y':  (  None,    None,   None,   None, None, None,    True),
            'ddm3y1': (0.2845,  3.6391, 2.9605, 0.0000,  0.0,  171 * 1000000,    True),
            'bdm3y0': (1.3827,   0.000, 0.0000, 1.1135,  2/3,  232 * 1000000,    False),
            'bdm3y1': (1.2253,   0.000, 0.0000, 1.5124,  1.0,  232 *1000000,    True),
            'bdm3y2': (1.0678,   0.000, 0.0000, 5.1069,  2.0,  354 * 1000000,    True),
            'bdm3y3': (1.0153,   0.000, 0.0000, 21.073,  3.0,  475 * 1000000,    True)
        },
        'paris': {      # C     alpha    beta     gamma   n    K [eV]  Implemented
            'dim3y':  (  None,    None,   None,    None, None,  None,   True),
            'ddm3y1': (0.2963,  3.7231, 3.7384,  0.0000,  0.0,   176 * 1000000,   True),
            'bdm3y1': (1.2521,  0.0000,  0.000,  1.7452,  1.0,   270 * 1000000,   True),
            'bdm3y2': (1.0664,  0.0000,  0.000,  6.0296,  2.0,   418 * 1000000,   True),
            'bdm3y3': (1.0045,  0.0000,  0.000, 25.1150,  3.0,   566 * 1000000,   True),
                         # C    alpha   beta  gamma  n, K [eV] Imlemented
            'cdm3y1': (0.3429, 3.0232, 3.5512, 0.5,  1,   188 * 1000000,    True),
            'cdm3y2': (0.3346, 3.0357, 3.0685, 1.0,  1,   204 * 1000000,    True),
            'cdm3y3': (0.2985, 3.4528, 2.6388, 1.5,  1,   217 * 1000000,    True),
            'cdm3y4': (0.3052, 3.2998, 2.3180, 2.0,  1,   228 * 1000000,    True),
            'cdm3y5': (0.2728, 3.7367, 1.8294, 3.0,  1,   241 * 1000000,    True),
            'cdm3y6': (0.2658, 3.8033, 1.4099, 4.0,  1,   252 * 1000000,    True)
        }}
